...
| <a name="output_sqs_queue_dlq_arn"></a> [sqs\_queue\_dlq\_arn](#output\_sqs\_queue\_dlq\_arn) | The ARN of the SQS DLQ |
| <a name="output_sqs_queue_dlq_name"></a> [sqs\_queue\_dlq\_name](#output\_sqs\_queue\_dlq\_name) | The name of the SQS DLQ |
